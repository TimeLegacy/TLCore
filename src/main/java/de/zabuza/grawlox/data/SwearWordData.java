...
public final class SwearWordData implements Comparable<SwearWordData> {
   ...
   *
   * @param swearWord The swearword of this data
   * @param beginIndex The index within the input where this swearword begins at
   */
  ...
  /**
   * Orders ascending by comparing the <tt>beginIndex</tt> given with {@link #getBeginIndex()}.
   */
  @Override
