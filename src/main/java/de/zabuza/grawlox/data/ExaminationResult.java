...
public final class ExaminationResult {
   ...
   *
   * @param input The input the results belong to.
   */
   ...
   *
   * @param swearWord The found swearword
   * @param beginIndex The index of the input where this swearword begins at
   */
   ...
   *
   * @param swearWordData The data to add
   */
