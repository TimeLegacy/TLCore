...
public final class MaxFinder {
  ...
  /**
   * Creates a new max finder with the initial maximum set to {@link Integer#MIN_VALUE}.
   */
  public MaxFinder() {
   ...
   *
   * @param initialMax The value to use as initial maximum
   */
  ...
  /**
   * Announces the given value to this finder. The finder will memorize the maximum of all announced values.
   *
   * @param value The value to announce
