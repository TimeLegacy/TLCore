 ...
 *
 * <p>This class follows the builder pattern, allowing for method chaining. It is set up such that
...
public class FancyMessage
  ...
  */
   ...
   * send this message to clients without JSON formatting support.
   *
   * <p>Serialization of this message by using this message will include (in this order for each
   * message part):
   *
   * <ol>
   * <li>The color of each message part.
   * <li>The applicable stylizations for each message part.
   * <li>The core text of the message part.
   * </ol>
   *
   * The primary omissions are tooltips and clickable actions. Consequently, this method should be
   * used only as a last resort.
   *
   * <p>Color and formatting can be removed from the returned string by using {@link
