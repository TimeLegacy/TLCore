 ...
 *
 * <p>Different instances of this class can be created with static constructor methods.
 */
public abstract class TextualComponent implements Cloneable {
   ...
   *
   * <p>If the specified translation key is not present on the client resource pack, the
   * translation
   ...
   * for the specified objective as the text represented by this component.
   *
  ...
  public static TextualComponent objectiveScore(String playerName, String scoreboardObjective) {
    ...
    // versions, in addition to updating ALL THE OVERLOADS documentation
    // accordingly

    return new ComplexTextTypeComponent(
        "score",
  ...
  private static final class ArbitraryTextTypeComponent extends TextualComponent
    ...
    public TextualComponent clone() {
      // Since this is a private and final class, we can just reinstantiate this class instead of
      // casting super.clone
    ...
    public static ComplexTextTypeComponent deserialize(Map<String, Object> map) {
      ...
      for (Map.Entry<String, Object> valEntry : map.entrySet()) {
        if (valEntry.getKey().equals("key")) {
          ...
          value.put(
              valEntry.getKey().substring(6) /* Strips out the value prefix */,
