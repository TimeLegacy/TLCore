...
public class JarUtils {
  ...
  public boolean extractFromJar(final String fileName, final String dest) throws IOException {
  ...
  private final void copyInputStream(final InputStream in, final OutputStream out)
      throws IOException {
    try {
