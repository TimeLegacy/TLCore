...
public class MuteCommand implements CommandExecutor {
  ...
  public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
    ...
    if (args.length == 0) {
      ...
      punishment.punish(Type.MUTE, reason, "NEVER", player.getUniqueId());
      MessageUtils.sendMessage(sender,
          MessageUtils.SECOND_COLOR + args[0] + MessageUtils.MAIN_COLOR + " is now muted.", true);
      ...
      punishment.punish(Type.MUTE, reason, expire, player.getUniqueId());
      MessageUtils.sendMessage(sender,
          MessageUtils.SECOND_COLOR + args[0] + MessageUtils.MAIN_COLOR + " is now muted.", true);
