...
public class CustomScoreboard {
   ...
   * CustomScoreboard#create()} in order to be used again
   */
  public void destroy() {
    if (!created) {
      return;
  ...
  /**
   * This class is used to manage the content of a line. Advanced users can use it as they want, but they are encouraged
   * to read and understand the code before doing so. Use these methods at your own risk.
   */
